...
from exportcharactertool_2016 import ExportCharacterTool
...
class MirrorTool(QtGui.QMainWindow):
    ...
    def __setup_ui(self):
        ...
        # character combobox
        self.characterComboBox = QtGui.QComboBox()
        self.characterLayout.addWidget(self.characterComboBox)

        # character export button
        self.characterExportBtn = QtGui.QPushButton('New character')
        ...
        self.characterReloadBtn = QtGui.QPushButton('Reload')
        ...
        # namespace layout
        self.nameSpaceLayout = QtGui.QHBoxLayout()
        ...
        # namespace combobox
        self.nameSpaceComboBox = QtGui.QComboBox()
        self.nameSpaceLayout.addWidget(self.nameSpaceComboBox)

        # namespace reload button
        self.nameSpaceReloadBtn = QtGui.QPushButton('Reload')
        ...
        self.customCheckBox = QtGui.QCheckBox()
        self.mirrorOptionsLayout.addWidget(self.customCheckBox)
        self.customCheckBox.stateChanged.connect(self.__set_plane)

        # line separator
        self.lineBelowMirrorOptions = QtGui.QFrame()
        self.lineBelowMirrorOptions.setFrameShape(QtGui.QFrame.HLine)
        ...
        # start frame
        self.startFrameTextBox = QtGui.QLineEdit()
        ...
        # end frame
        self.endFrameTextBox = QtGui.QLineEdit()
        ...
        # frame range button
        self.frameRangeBtn = QtGui.QPushButton('From scene')
        ...
        # line separator
        self.lineBelowFrameRangeOptions = QtGui.QFrame()
        self.lineBelowFrameRangeOptions.setFrameShape(QtGui.QFrame.HLine)
        ...
        # mirror button
        self.mirrorBtn = QtGui.QPushButton('mirror')
