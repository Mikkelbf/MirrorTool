...
import os
import json
import utilities_2017 as utilities


class ExportCharacterTool(QtWidgets.QMainWindow):
    ...
    def __setup_ui(self):
        ...
        self.orientationLayout = QtWidgets.QHBoxLayout()
        self.mainLayout.addLayout(self.orientationLayout)

        self.forwardLayout = QtWidgets.QHBoxLayout()
        ...
        self.listOneLayout = QtWidgets.QVBoxLayout()
        self.listOneLayout.setAlignment(QtCore.Qt.AlignTop)

        self.listOneScroll = QtWidgets.QScrollArea()
        ...
        self.listOneScrollWidget = QtWidgets.QWidget(self.listOneScroll)
        ...
        self.addLayout = QtWidgets.QHBoxLayout()
        ...
        self.removeButton = QtWidgets.QPushButton('Remove All')
        ...
        self.listTwoLayout = QtWidgets.QVBoxLayout()
        ...
        self.matchButton = QtWidgets.QPushButton('Auto Match')
        self.listTwoLayout.addWidget(self.matchButton)
        self.matchButton.clicked.connect(self.__auto_match)

        self.addSelectedButton = QtWidgets.QPushButton('Add Selected')
    ...
    def __add_entry(self):
        ...
        # add comboboxes
        comboBoxOne = QtWidgets.QComboBox()
        comboBoxTwo = QtWidgets.QComboBox()
    ...
    def __get_file_dir(self):
        chr = str(QtWidgets.QInputDialog.getText(self, '', 'Name:')[0])
